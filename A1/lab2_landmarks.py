...
# PATH TO ALL IMAGES
basedir = r'/Users/Hyunjee/Desktop/AMLS_19-20_SN16075203/A1'
images_dir = basedir + r'/datasets'
...
def extract_features_labels(target_index):
    ...
    :return:
        ...
        labels:      an array containing the gender label (male=0 and female=1) and emotion label (smiling=0 and notsmiling=1)                        for each image in which a face was detected
    """
...
# def extract_features_labels(images_dir = images_dir):
#     """
#     This funtion extracts the landmarks features for all images in the folder 'dataset/celeba'.
#     It also extracts the gender label for each image.
#     :return:
